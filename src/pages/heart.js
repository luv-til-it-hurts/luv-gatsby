...
<div className="heartgrid">
    ...
    <CatDesc slug={data.cat.slug} color={data.cat.ACFCategoryData.colorHigh}  image={data.cat.ACFCategoryData.pageicon.localFile.publicURL} description={data.cat.description}/>
